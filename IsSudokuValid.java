// Given a 2D array, board[][] of size 9 × 9, which represents a solution to the 
// Sudoku puzzle, the task is to check if the given representation of a solved Sudoku 
